...
pub use revocation::{read_revocation, responder_url, revocation_query, Revocation};
pub use sign::{embed_signature, prepare, Prepared, SignatureOptions, DEFAULT_CAPACITY};
